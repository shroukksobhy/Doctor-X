				...
				<div class="col-sm-4 col-xs-12">
					<div class="btn-group">
					  <div class="btn-group">
						...
						Speciality <span class="caret"></span></button>
						<ul class="dropdown-menu" role="menu">
						  <li><a href="#">Dentist</a></li>
						  <li><a href="#">Sergary</a></li>
						</ul>
					  </div>
						<div class="btn-group">
						<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
						  ...
						  <li><a href="#">EL Shorouk</a></li>
						</ul>
					  </div>
						<div class="btn-group">
						<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
						Doctor Name <span class="caret"></span></button>
						<ul class="dropdown-menu" role="menu">
						  <li>
							  <a href="#">Dalia<button type="submit" class="btn btn-default">Show profile</button></a> 
							  
							</li>
						  <li>
							  <a href="#">Amany <button type="submit" class="btn btn-default">Show profile</button></a>
							</li>
							<li>
								<a href="#">Shourok <button type="submit" class="btn btn-default">Show profile</button></a>
							</li>
						  <li>
							  <a href="#">Ahmed <button type="submit" class="btn btn-default">Show profile</button></a>
							</li>
						</ul>
					  </div>
