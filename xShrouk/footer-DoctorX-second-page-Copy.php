			...
			<div class="row">
				<div class="col-sm-3 col-xs-4">
					 <ul class="nav nav-pills nav-stacked">
						 <li><img src="Unknown_male.jpg" class="img-responsive" alt="unknown"></li>
						...
						<li><a data-toggle="pill" href="#LI5">Login info</a></li>
						 <li><a data-toggle="pill" href="#LO6">LogOut</a></li>
				...
				<div class="col-sm-9 col-xs-8">
					<div class="tab-content cont">
						<div id="Schedule" class="tab-pane fade in active">
						  <h3>Schedule</h3>
						  <p>bla bla lbaalal bla bla lbaalalbla bla lbaalalbla bla lbaalalbla bla lbaalalbla bla lbaalalbla bla lbaalalbla bla lbaalalbla bla lbaalalbla bla lbaalalbla bla lbaalal</p>
						</div>
